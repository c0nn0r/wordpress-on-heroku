...
?>
<?php if(have_comments() || 'open' == $post->comment_status) : ?> <div id="commentBox" > <div class="inside"><?php endif; ?>
...
<?php if(have_comments() || 'open' == $post->comment_status) : ?> </div></div> <?php endif; ?>
